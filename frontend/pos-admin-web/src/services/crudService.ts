    ...
    switch (this.entityType) {
      ...
      case 'category':
        ...
        await loggingService.logCategoryUpdated(
          ...
          { categoryName: oldCategory.name, color: oldCategory.color, menuCount: oldCategory.menuCount },
          { categoryName: newCategory.name, color: newCategory.color, menuCount: newCategory.menuCount }
        );
        break;
      case 'menu':
    ...
    switch (this.entityType) {
      case 'place':
        ...
        await loggingService.logPlaceDeleted(place.name, place.color, {
          placeId: place.id,
          preData: { placeName: place.name, color: place.color, tableCount: place.tableCount },
          ...extraData
        });
        break;
      case 'table':
