import type {
  ...
  Menu, MenuCreateRequest, MenuUpdateRequest, MenuResponse,
  Place, PlaceCreateRequest, PlaceUpdateRequest, PlaceResponse,
  Table, TableCreateRequest, TableUpdateRequest, TableResponse
} from '@wafl/store-info';
...
// Category & Menu Types (shared types에서 가져옴)
export type { Category, CategoryCreateRequest, CategoryUpdateRequest, CategoryResponse, 
  Menu, MenuCreateRequest, MenuUpdateRequest, MenuResponse,
  Place, PlaceCreateRequest, PlaceUpdateRequest, PlaceResponse, 
  Table, TableCreateRequest, TableUpdateRequest, TableResponse } from '@wafl/store-info';
