...
import { ITableCreateRequest, ITableUpdateRequest, ITableFilters } from '../types';
...
export class TableService {
  ...
  async create(storeId: string, data: ITableCreateRequest): Promise<{
    table: Table;
    qrCode: string;
  }> {
    // 매장 정보 조회
