...
### 🔄 진행 중 (다음 우선순위)
- **🎯 API Gateway Service** (포트 8080) - 중앙 라우팅 허브
- **📊 Store Management Service** (포트 3002) - 매장 관리 시스템
...
├── ⚠️ store-management-service (3002) - 매장 관리
...
🔧 Support Services (10개) - ⚠️ 모두 구현 대기
├── api-gateway (8080) - 🎯 다음 우선순위
├── payment-service (3005) - 결제 처리
├── ai-service (3006) - AI Agent
└── [7개 추가 서비스...]
